...
const useInjectScript = (args) => {
    const [scriptReady, setScriptReady] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false);
    const [scriptFailed, setScriptFailed] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false);

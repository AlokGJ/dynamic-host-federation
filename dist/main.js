...
var DynamicComponent = function DynamicComponent(props) {
  ...
  if (!props.config) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "No Config specified");
  }

  if (!scriptReady) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Loading dynamic script: ", props.config.url);
  }

  if (scriptFailed) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Failed to load dynamic script: ", props.config.url);
  }
